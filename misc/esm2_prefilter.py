...
def main():
    ...
    ap.add_argument('--out', default=None, metavar='TSV',
                    help='Output TSV path (default: misc/dmasif/esm2_prefilter_{apo_stem}[_union|_explicit].tsv)')
    ...
    if args.iface_residues:
        ...
        suffix = ''
    cache_path = f'misc/dmasif_cache/A_interface_cache_{apo_stem}_{bound_stem}{suffix}.npz'
    out_path   = args.out or f'misc/dmasif/esm2_prefilter_{apo_stem}{suffix}.tsv'
