...
Output:
  ...
  Saves to --out TSV (default: misc/interface_residues.tsv).
"""
...
def main():
    ...
    ap.add_argument('--work-dir',     default='misc/interface_tmp',
                    help='Working directory for Amina outputs.')
    ap.add_argument('--out',          default='misc/interface_residues.tsv',
